...
CDistortionBase::CDistortionBase()
{
...
//==========================================================================
CNoDist::CNoDist(): CDistortionBase(){}
...
//==========================================================================
//CTanhDist::CTanhDist(double sampleRate, int numChannels, int numSamples) : CDistortionBase(){}//CDistortionBase(sampleRate, numChannels, numSamples){}
