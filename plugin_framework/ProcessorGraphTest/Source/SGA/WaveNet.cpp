...
WaveNet::WaveNet(int inputChannels, int outputChannels, int convolutionChannels,
    ...
    dilations(dilations)
{
//    cout << "If program continuously print these data means init failed." << endl;
//    cout << "Inputchannels " << inputChannels << endl;
//    cout << "outputchannels " << outputChannels << endl;
//    cout << "filterwidth " << filterWidth << endl;
//    cout << "skipchannels " << skipChannels << endl;
//    cout << "convolutionchannels " << convolutionChannels << endl;
//    cout << "memoryChannels " << memoryChannels << endl;
//    cout << "activation " << activation << endl;
//    cout << "dilations ";
//    for(int i = 0; i < dilations.size(); i++)
//        cout << dilations[i] << ", ";
//    cout << endl;
//    cout << "samplesPerBlock " << samplesPerBlock << endl;
}

void WaveNet::readDilations(juce::var config)
{
...
//    for (int i = 0; i < convData.getNumSamples(); i++)
//        DBG(convData.getSample(0, i));
